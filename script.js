 ...
 var enterSName = document.getElementById("enterSName").value;
  var findSenderBankAccount = enterSName + "BankBalance";
    ...
    if (enterAmount > enterSAmount) {
       ...
       $${enterAmount} is sent to ${enterName}@ncb.com.`)
 
       // transaction history 
       var createPTag = document.createElement("li");
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with Bank-id ${enterSName}@ncb.com
  to recepient with Bank-id-id ${enterName}@ncb.com on ${Date()}.`);
